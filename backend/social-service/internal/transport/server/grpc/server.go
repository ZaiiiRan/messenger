	...
	return grpc.ChainUnaryInterceptor(
		...
		commonmiddleware.UserAuthMiddleware(
			...
			commonmiddleware.MiddlewareOnly(
				...
				"/social.v1.SocialService/GetFriends",
				"/social.v1.SocialService/GetIncomingFriendRequests",
				"/social.v1.SocialService/GetOutgoingFriendRequests",
				"/social.v1.SocialService/GetBlockedUsers",
				"/social.v1.SocialService/SearchUsers",
