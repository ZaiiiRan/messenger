...
const emailChangeHTMLTpl = `<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width,initial-scale=1.0">
...
<table role="presentation" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:20px;overflow:hidden;">
	...
	<tr>
		<td align="center" style="background:linear-gradient(135deg,#0ea5e9 0%,#0369a1 100%);padding:44px 48px 40px;">
			<p style="margin:0 0 6px;color:#ffffff;font-size:26px;font-weight:700;font-family:Arial,Helvetica,sans-serif;">Messenger</p>
			<p style="margin:0;color:rgba(255,255,255,0.82);font-size:13px;font-weight:600;letter-spacing:1.8px;text-transform:uppercase;font-family:Arial,Helvetica,sans-serif;">{SUBTITLE}</p>
		</td>
	</tr>
	...
	<tr>
		<td style="background-color:#f0f9ff;border-bottom:1px solid #bae6fd;padding:14px 48px;">
			<p style="margin:0;color:#0369a1;font-size:13px;text-align:center;font-family:Arial,Helvetica,sans-serif;">&#9432; {WARNING}</p>
		</td>
	</tr>
	...
	<tr>
		<td style="padding:40px 48px 36px;">
			...
			<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:32px;">
				<tr>
					<td align="center" style="background-color:#f0f9ff;border:2px solid #bae6fd;border-radius:16px;padding:28px 20px;">
						<p style="margin:0 0 10px;color:#0ea5e9;font-size:11px;font-weight:700;letter-spacing:2.5px;text-transform:uppercase;font-family:Arial,Helvetica,sans-serif;">{CODE_LABEL}</p>
						<p style="margin:0;color:#0c4a6e;font-size:46px;font-weight:800;letter-spacing:16px;padding-left:16px;font-family:'Courier New',Courier,monospace;">{CODE}</p>
					</td>
				</tr>
			</table>
			...
			<table role="presentation" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td align="center">
						<a href="{TOKEN_URL}" style="display:inline-block;background:linear-gradient(135deg,#0ea5e9 0%,#0369a1 100%);color:#ffffff;text-decoration:none;font-size:15px;font-weight:700;padding:16px 56px;border-radius:50px;font-family:Arial,Helvetica,sans-serif;">{BUTTON}</a>
					</td>
				</tr>
			</table>
		</td>
