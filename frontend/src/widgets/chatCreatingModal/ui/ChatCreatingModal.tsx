                ...
                <AnimatePresence mode='popLayout'>
                {
                    show && (
                        ...
                        layoutId="modal"
                            ...
                            className={`${styles.ChatCreatingModalBG} fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center bg-black bg-opacity-50`}
                        >
                            <motion.div 
                            layoutId="modal-content"
                                ...
                                transition={{ duration: 0.3 }}
                                className={`${styles.ChatCreatingModal} flex flex-col rounded-3xl gap-8 2k:gap-14 4k:gap-24`}
                            >
