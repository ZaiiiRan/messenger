...
const AppearanceOptions = ({ goBack }) => {
    ...
    return (
        <motion.div 
            ...
            className='Options-Widget rounded-3xl flex flex-col gap-8 2k:gap-14 4k:gap-24 z-5'
        >
            <div className='flex items-center gap-5 2k:gap-7 4k:gap-9'>
                <div 
                    className='backBtn 2xl:w-10 2xl:h-10 xl:w-9 xl:h-9 lg:w-8 lg:h-8 2k:w-12 2k:h-12 4k:w-14 4k:h-14 rounded-3xl flex items-center justify-center'
                    onClick={goBack}
                >
            ...
            <div className='flex flex-col gap-8 2k:gap-12 4k:gap-20'>
                <div className='flex 2xl:w-1/2 xl:w-4/6 lg: 5/6 justify-between'>
                    <div className='flex items-center gap-3'>
                        ...
                        <div className='2xl:text-lg xl:text-base lg:text-sm 2k:text-xl 4k:text-2xl'>{ t('Language') }</div>
                    </div>
                    
                    <Select 
                        className='w-3/5 2xl:text-lg xl:text-base lg:text-sm 2k:text-xl 4k:text-2xl' 
                        options={langs} 
                ...
                <div className='flex 2xl:w-1/2 xl:w-4/6 lg: 5/6 justify-between'>
                    <div className='flex items-center gap-3'>
                        ...
                        <div className='2xl:text-lg xl:text-base lg:text-sm 2k:text-xl 4k:text-2xl'>{ t('Theme') }</div>
                    </div>
