...
const Message = ({ className, text, from, time, read, displayFrom=false, key, id }) => {
        ...
        >
            ...
            >
                <div className='flex flex-col md:gap-2 mobile:gap-1 2k:gap-3 4k:gap-4'>
                    ...
                    <div className='mobile:text-sm md:text-base 2k:text-xl 4k:text-2xl'>{text}</div>
                </div>
                <div 
                ...
                >
                    <div className={`${styles.Time} flex-shrink-0`} >{ time }</div>
                    {
                        isMessageFromMe && (
