        ...
        <AnimatePresence mode='popLayout'>
            {
                ...
                >
                    ...
                    <div className='flex w-full h-auto gap-9 4k:gap-14'>
                        ...
                        >
                            <div
                                className='font-bold lg:text-xl 2k:text-3xl 4k:text-5xl
                                md:text-2xl sm:text-xl mobile:text-xl'
                            >
                            ...
                            { 
                                userStore.user.phone && (
                                    <div>Номер телефона: { userStore.user.phone }</div>
                                )    
                            }
                            { 
                                userStore.user.birthdate && (
                                    <div>Дата рождения: { new Date(userStore.user.birthdate).toLocaleDateString() }</div>
                                )    
                            }
                        </div>
                    </div>
